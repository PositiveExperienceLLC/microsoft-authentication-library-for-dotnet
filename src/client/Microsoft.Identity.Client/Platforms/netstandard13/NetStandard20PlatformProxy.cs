...
namespace Microsoft.Identity.Client.Platforms.netstandard13
{
    ...
    /// </summary>
    internal class Netstandard20PlatformProxy : AbstractPlatformProxy
    {
        public Netstandard20PlatformProxy(ICoreLogger logger)
            : base(logger)
        {
        }
        ...
        protected override ICryptographyManager InternalGetCryptographyManager() => new NetStandard20CryptographyManager();
